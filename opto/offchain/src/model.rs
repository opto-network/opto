	...
	pub mod objects {
		...
		pub mod calls {
			...
			pub mod types {
				...
				pub mod apply {
					use {super::runtime_types, opto_core::repr::Compact};
					pub type Transitions = ::subxt::ext::subxt_core::alloc::vec::Vec<
						runtime_types::opto_core::transition::Transition<
		...
		pub mod events {
			...
			pub mod state_transitioned {
				use {crate::runtime_types, opto_core::repr::Compact};
				pub type Transition = runtime_types::opto_core::transition::Transition<
					opto_core::repr::Compact,
				>;
			}
			...
			pub mod pallet_objects {
				...
				pub mod pallet {
					...
					pub enum Event {
						#[codec(index = 0)]
						StateTransitioned {
							transition: runtime_types::opto_core::transition::Transition<
								opto_core::repr::Compact,
							>,
						},
						#[codec(index = 1)]
